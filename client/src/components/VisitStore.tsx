import storeImg from "../assets/map/store_banner_homepage.png";
...
export default function VisitStore() {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 min-h-[380px]">
        ...
        <div className="relative overflow-hidden min-h-[220px] sm:min-h-[380px]">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(28,59,72,0.95) 0%, transparent 100%)",
            }}
          >
            <span
        ...
        >
            ...
            {[
              {
                icon: "",
                label:
                  "610 , The Lenora Complex , Opp Saint Thomas School ,New Citylight Road , Surat 395007",
              },
            ].map((item) => (
              <span
                key={item.label}
              ...
              >
                <span style={{ color: "#dbd5b5", fontSize: "11px" }}>
                  {item.icon}
                </span>
                {item.label}
              </span>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 mt-2">
            ...
            <a
              ...
              onMouseLeave={(e) =>
                (e.currentTarget.style.background = "#dbd5b5")
              }
            >
              Get Directions
              <svg
      ...
      >
        {[{ num: "25+", label: "YEARS PERFECTING THE CRAFT" }].map(
          (stat, i) => (
            <div
              key={stat.label}
