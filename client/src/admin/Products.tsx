...
export default function Products() {
  ...
  const saveDiamondOption = async () => { const name = newDiamondCategory.trim(); if (!name) return showToast("Enter a diamond category name.", "error"); try { await adminApi.saveDiamondCategory(name); setNewDiamondCategory(""); await load(); showToast("Diamond category saved.", "success"); } catch (error) { showToast(error instanceof Error ? error.message : "Diamond category could not be saved.", "error"); } }; const saveDiamondSubcategory = async () => { const name = newDiamondSubType.trim(); if (!name) return showToast("Enter a diamond subcategory name.", "error"); try { await adminApi.saveDiamondSubcategory(name); setNewDiamondSubType(""); await load(); showToast("Diamond subcategory saved.", "success"); } catch (error) { showToast(error instanceof Error ? error.message : "Diamond subcategory could not be saved.", "error"); } };
