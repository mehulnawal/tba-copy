...
const cardVariants = {
  ...
  visible: {
    opacity: 1,
    y: 0,
    transition: { duration: 0.55, ease: [0.215, 0.61, 0.355, 1.0] as const },
  },
  exit: {
    opacity: 0,
    scale: 0.98,
      ...
      <div className="relative aspect-[4/5] w-full overflow-hidden bg-[var(--color-cream-light)]">
        ...
        {imageError ? (
          ...
          <img
            ...
            className={`w-full h-full object-cover object-center transition-transform duration-700 ease-[0.25,1,0.5,1] group-hover:scale-105 ${
        ...
        <div className="container section-padding">
          ...
          <header className="max-w-3xl mx-auto text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="font-secondary text-sm text-[var(--color-text-muted)] tracking-wide font-light max-w-md mx-auto leading-relaxed">
              A curated gallery of your saved treasures. Review, manage, or
              transfer your chosen pieces to the shopping vault.
            </p>
            ...
            {isPageLoading ? (
              ...
              >
                ...
                <p className="font-secondary text-xs sm:text-sm text-[var(--color-text-muted)] tracking-wide font-light max-w-xs mx-auto leading-relaxed mb-8">
                  As you explore our seasonal haute collections, flag the
                  timeless statement designs that inspire you.
                </p>
                <button
                  type="button"
