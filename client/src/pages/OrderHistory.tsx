      ...
      <main className="min-h-screen bg-[var(--color-bg)] py-16 px-4 md:px-8">
        <div className="container max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-8 mb-10 border-b border-[var(--color-border-subtle)] pb-2">
            ...
            <button className="font-secondary pb-2 text-sm uppercase tracking-widest text-[var(--color-teal)] font-medium transition-all duration-300 relative">
              My Orders
                ...
                return (
                  ...
                  >
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  ...
                                  <p className="font-secondary text-xs text-[var(--color-text-muted)] mt-1">
                                    Metal:{" "}
                                    <span className="uppercase text-[var(--color-text)] font-medium">
                                      {i.karat}
                                    </span>
                                  </p>
                                  {i.size && (
                    ...
                    <div className="mt-6 pt-4 border-t border-[var(--color-border-subtle)] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div>
                        <span className="font-secondary text-xs uppercase tracking-wider text-[var(--color-text-muted)] block">
                          Total
                        </span>
