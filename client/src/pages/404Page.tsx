...
const ERROR_SUBTEXT =
  "Like an unpolished stone or a design sketch yet realized, this specific space remains undefined. Let our advisors guide you back to our curated collections.";
    ...
    <>
      ...
      >
        ...
        <header className="w-full h-[var(--navbar-height)] border-b border-[var(--color-border-subtle)] bg-white/80 backdrop-blur-md flex items-center justify-center shrink-0 z-30 sticky top-0">
          <a
            href="/"
            className="flex items-center select-none focus:outline-none transition-transform duration-300 active:scale-95"
            aria-label="Home"
          >
            <img
              src={logoAsset}
                ...
                {[
                  {
                    label: "Gold Rings",
                    category: "Rings",
                    description: "Timeless statements for fingers.",
                  },
                  {
                    label: "Necklaces",
                    category: "Necklaces",
                    description: "Sculpted chains and links.",
                  },
                  {
                    label: "Statement Earrings",
                    category: "Earrings",
                    description: "Refined structural drop pairs.",
                  },
                  {
                    label: "Luxury Bracelets",
                    category: "Bracelets",
                    description: "Classic wrist ornamentation.",
                  },
                ].map((item, idx) => (
                  <button
                    key={idx}
                  ...
                  >
                    <div className="w-full flex justify-between items-center mb-2">
                      <Compass
                        className={`w-4 h-4 transition-transform duration-500 ${activeCard === idx ? "text-[var(--color-teal)] rotate-45" : "text-[var(--color-text-muted)] opacity-60"}`}
                      />
                      <span className="text-[9px] tracking-widest text-[var(--color-cream)] font-mono">
                        0{idx + 1}
                      </span>
                    </div>
                    <div>
