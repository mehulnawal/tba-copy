...
export default function B2BAccess() {
  ...
  const resendOtp = async () => {
    ...
    try { setOtpRequestId(await retryMsg91Otp(otpRequestId)); setNotice("A new OTP has been sent."); otpRefs.current[0]?.focus(); }
