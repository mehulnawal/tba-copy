...
export default function B2BProductDetails() {
  ...
  return <><Seo title={`${product.title} | TBA B2B`} description={product.description || `Review ${product.title} specifications and B2B pricing at TBA Jewelry.`} /><main className="min-h-screen bg-[var(--color-bg)] px-5 py-10 md:px-12"><Link to="/b2b/catalog" className="inline-flex items-center gap-1 text-sm text-[var(--color-teal)]"><ChevronLeft size={16} /> Back to catalogue</Link><section className="mx-auto mt-6 grid max-w-7xl gap-10 lg:grid-cols-2">
