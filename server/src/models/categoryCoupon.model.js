...
const { CATEGORY_COUPON_CATEGORIES } = require("../constants/categoryCoupon.constants");

const categoryCouponSchema = new mongoose.Schema({
  category: { type: String, enum: Object.values(CATEGORY_COUPON_CATEGORIES), required: true, unique: true },
